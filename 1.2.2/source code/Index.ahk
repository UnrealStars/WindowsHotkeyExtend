...
;==================================================
;检测多余的开机启动项
RegRead, i_startUp, HKLM\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Run, WindowsHotkeyExtend
if i_startUp
	RegDelete, HKLM\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Run, WindowsHotkeyExtend
;==================================================
...
if (b_firstRun != 1)
{
	...
	IfNotExist, %A_ScriptDir%\帮助说明.txt
	{
		...
		MsgBox, 1, 第一次运行提示, “帮助说明.txt”已创建，是否打开？
		IfMsgBox OK
		{
